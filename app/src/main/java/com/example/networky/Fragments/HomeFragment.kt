...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        arrayofimg.add(R.drawable.theme3)
        arrayofimg.add(R.drawable.theme0)
        arrayofimg.add(R.drawable.theme1)
        arrayofimg.add(R.drawable.theme2)
        arrayofimg.add(R.drawable.theme3)
        arrayofimg.add(R.drawable.theme4)
        arrayofimg.add(R.drawable.theme5)
        arrayofimg.add(R.drawable.theme2)
        arrayofimg.add(R.drawable.theme3)
        arrayofimg.add(R.drawable.theme1)
        arrayofimg.add(R.drawable.theme4)
